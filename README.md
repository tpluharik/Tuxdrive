...
Version 0.20.0 targets Ubuntu 24.04/26.04 and Debian 12/13 GNOME on amd64 and arm64. It fixes streaming offline retention with visible per-item hydration state, adds editable internal folder groups, and adds GitHub repository synchronization through system Git. It retains the 0.19 security baseline and the unbranded six-state Nautilus badges introduced in 0.19.2. Searchable offline documentation and persistent English, German, French, Spanish, Arabic and Hebrew localization remain included.
...
The following controls are enforced in 0.20.0:
...
### 0.20.0 offline availability, groups and GitHub
...
The installer is written to `dist/tuxdrive_0.20.0_all.deb`. TuxDrive publishes Debian packages only.
