...
The following controls are enforced in 0.25.1:
...
The installer is written to `dist/tuxindrive_0.25.1_all.deb`. TuxInDrive publishes Debian packages only.
