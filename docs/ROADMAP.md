...
## Current baseline: 0.19.2

Version 0.19.2 replaces branded Nautilus state overlays with six dedicated functional badges whose colors, silhouettes, and symbols remain distinct at normal file-manager sizes. It retains the complete 0.19.0 critical/high remediation and the signed 0.19.1 trust bridge: privileged update re-verification, isolated peer-role/drop endpoints, and bounded ODT/ODS plus CRDT operation input. Six-language documentation and the 0.17 collaboration baseline remain available.
