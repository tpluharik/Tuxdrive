...
| Area | 0.20.8 behavior | Security purpose |
|---|---|---|
...
| CI/release | Pinned GitHub Action SHAs, 160 tests, compile checks, high-severity Bandit, `pip-audit`, Debian inspection, CycloneDX SBOM, signed-manifest verification | Make security regressions and vulnerable dependencies release blockers |
...
2. Confirm the running version is 0.20.8 and the update check reports a valid signature and expiry.
