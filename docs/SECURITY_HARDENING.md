...
| Area | 0.26.5 behavior | Security purpose |
|---|---|---|
...
2. Confirm the running version is 0.26.5 and the platform update check reports a valid signature, origin, filename, digest, size, architecture and expiry.
