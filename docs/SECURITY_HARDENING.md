...
| Area | 0.20.10 behavior | Security purpose |
|---|---|---|
...
2. Confirm the running version is 0.20.10 and the update check reports a valid signature and expiry.
