...
| Area | 0.21.0 behavior | Security purpose |
|---|---|---|
...
2. Confirm the running version is 0.21.0 and the update check reports a valid signature and expiry.
