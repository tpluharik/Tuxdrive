...
| Area | 0.20.11 behavior | Security purpose |
|---|---|---|
...
2. Confirm the running version is 0.20.11 and the update check reports a valid signature and expiry.
