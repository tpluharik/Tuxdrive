...
Download `tuxindrive-server_0.26.17_all.deb` from the matching
[GitHub Release](https://github.com/tpluharik/Tuxindrive/releases/tag/v0.26.17),
...
installing 0.26.17 replaces its launcher and completes the pending package
...
dpkg-deb --info dist/tuxindrive-server_0.26.17_all.deb
dpkg-deb --contents dist/tuxindrive-server_0.26.17_all.deb
sudo apt install ./dist/tuxindrive-server_0.26.17_all.deb
```
