...
Download `tuxindrive-server_0.26.16_all.deb` from the matching
[GitHub Release](https://github.com/tpluharik/Tuxindrive/releases/tag/v0.26.16),
...
installing 0.26.16 replaces its launcher and completes the pending package
...
sudo apt install ./dist/tuxindrive-server_0.26.16_all.deb
```
