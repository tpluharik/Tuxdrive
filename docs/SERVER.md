...
Download `tuxindrive-server_0.26.18_all.deb` from the matching
[GitHub Release](https://github.com/tpluharik/Tuxindrive/releases/tag/v0.26.18),
...
installing 0.26.18 replaces its launcher and completes the pending package
...
dpkg-deb --info dist/tuxindrive-server_0.26.18_all.deb
dpkg-deb --contents dist/tuxindrive-server_0.26.18_all.deb
sudo apt install ./dist/tuxindrive-server_0.26.18_all.deb
```
