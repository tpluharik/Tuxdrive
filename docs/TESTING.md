...
dpkg-deb --info dist/tuxindrive_0.25.1_all.deb
dpkg-deb --contents dist/tuxindrive_0.25.1_all.deb
sha256sum dist/tuxindrive_0.25.1_all.deb
```
...
```bash
python3 scripts/sign-update.py --version 0.25.1 \
  --package dist/tuxdrive_0.25.1_all.deb \
