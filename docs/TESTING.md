...
| `test_nautilus_extension.py` | 2 | Exact sibling/parent exclusion in the packaged extension and last-known-good job metadata when an atomic state/configuration read is transiently unavailable. |
