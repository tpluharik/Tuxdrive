...
dpkg-deb --info dist/tuxindrive_0.26.18_all.deb
dpkg-deb --contents dist/tuxindrive_0.26.18_all.deb
sha256sum dist/tuxindrive_0.26.18_all.deb
```
...
```bash
python3 scripts/sign-update.py --version 0.26.18 \
  --package dist/tuxindrive_0.26.18_all.deb \
