...
dpkg-deb --info dist/tuxindrive_0.26.9_all.deb
dpkg-deb --contents dist/tuxindrive_0.26.9_all.deb
sha256sum dist/tuxindrive_0.26.9_all.deb
```
...
```bash
python3 scripts/sign-update.py --version 0.26.9 \
  --package dist/tuxindrive_0.26.9_all.deb \
