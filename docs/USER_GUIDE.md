...
Reinstall the current package with `sudo apt install ./tuxindrive_0.26.19_all.deb`.
...
### Security upgrade checklist for 0.26.19

1. Install `tuxindrive_0.26.19_all.deb`; the upgrade closes an older running TuxInDrive instance. Reopen TuxInDrive and restart Nautilus.
2. Confirm **Settings → Check for updates** reports 0.26.19 and no signature or expiry error.
