...
PACKAGE_ROOT="$PROJECT_ROOT/build/tuxdrive_0.3.0_all"
OUTPUT="$PROJECT_ROOT/dist/tuxdrive_0.3.0_all.deb"
...
PYTHONPATH="$PACKAGE_ROOT/usr/lib" /usr/bin/python3 -c \
  'import importlib.util, tuxdrive; assert tuxdrive.__version__ == "0.3.0"; assert importlib.util.find_spec("tuxdrive.app")'
