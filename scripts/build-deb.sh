...
PACKAGE_ROOT="$PROJECT_ROOT/build/tuxdrive_0.21.1_all"
OUTPUT="$PROJECT_ROOT/dist/tuxdrive_0.21.1_all.deb"
...
PYTHONPATH="$PACKAGE_ROOT/usr/lib" /usr/bin/python3 -c \
  'import importlib.util, tuxdrive; assert tuxdrive.__version__ == "0.21.1"; assert importlib.util.find_spec("tuxdrive.app"); assert importlib.util.find_spec("tuxdrive.i18n"); assert importlib.util.find_spec("tuxdrive.help_content"); assert importlib.util.find_spec("tuxdrive.folder_layout"); assert importlib.util.find_spec("tuxdrive.collaboration"); assert importlib.util.find_spec("tuxdrive.platform_support"); assert importlib.util.find_spec("tuxdrive.updater"); assert importlib.util.find_spec("tuxdrive.update_helper"); assert importlib.util.find_spec("tuxdrive.peer"); assert importlib.util.find_spec("tuxdrive.tor"); assert importlib.util.find_spec("tuxdrive.recovery"); assert importlib.util.find_spec("tuxdrive.delta"); assert importlib.util.find_spec("tuxdrive.policies"); assert importlib.util.find_spec("tuxdrive.audit"); assert importlib.util.find_spec("tuxdrive.capabilities"); assert importlib.util.find_spec("tuxdrive.migration"); assert importlib.util.find_spec("tuxdrive.security"); assert importlib.util.find_spec("tuxdrive.github_sync"); assert importlib.util.find_spec("tuxdrive.nautilus_support")'
