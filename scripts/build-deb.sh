...
PACKAGE_ROOT="$PROJECT_ROOT/build/tuxindrive_0.25.2_all"
OUTPUT="$PROJECT_ROOT/dist/tuxindrive_0.25.2_all.deb"
LEGACY_OUTPUT="$PROJECT_ROOT/dist/tuxdrive_0.25.2_all.deb"
