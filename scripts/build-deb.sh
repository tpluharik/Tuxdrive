...
PACKAGE_ROOT="$PROJECT_ROOT/build/tuxdrive_0.4.1_all"
OUTPUT="$PROJECT_ROOT/dist/tuxdrive_0.4.1_all.deb"
...
PYTHONPATH="$PACKAGE_ROOT/usr/lib" /usr/bin/python3 -c \
  'import importlib.util, tuxdrive; assert tuxdrive.__version__ == "0.4.1"; assert importlib.util.find_spec("tuxdrive.app")'
